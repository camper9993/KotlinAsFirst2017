...
fun russian(n: Int): String {
    ...
    val list1 = listOf("один", "два", "три", "четыре", "пять",
            "шесть", "семь", "восемь", "девять")
    val list2 = listOf("десять", "двадцать", "тридцать", "сорок",
    ...
    val list6 = listOf("одиннадцать", "двенадцать", "тринадцать", "четырнадцать",
